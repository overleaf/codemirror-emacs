...
var commands__namespace = /*#__PURE__*/_interopNamespaceDefault(commands);
...
const emacsKeys = {
    ...
    // TODO use iSearch
    "C-s": search.openSearchPanel, // "iSearch", 
    "C-r": search.openSearchPanel, // "iSearchBackwards",
    "M-C-s": "findnext",
    "M-C-r": "findprevious",
    "S-M-5": "replace",
    // basic editing
    ...
    "S-C-/|S-C-x u|C--|S-C-z": commands__namespace.redo, // infinite undo?
    // vertical editing
